Pod::Spec.new do |s|
  ...
  s.subspec 'VMNVideoPlayer' do |vmnplayer|
	...
	vmnplayer.xcconfig = { 'FRAMEWORK_SEARCH_PATHS' => '"$(PODS_ROOT)/Pods/VMNVideoPlayer-iOS-SDK/FrameworkSource/libVMNVideoPlayeriOSSDK"/** "$(PODS_ROOT)/Pods/VMNVideoPlayer-iOS-SDK/FrameworkSource/libVMNVideoPlayeriOSSDK/VMNVideoPlayer.framework/Versions/A"/**', 'LIBRARY_SEARCH_PATHS' => '"$(PODS_ROOT)/Pods/VMNVideoPlayer-iOS-SDK/FrameworkSource/libVMNVideoPlayeriOSSDK"/** "$(PODS_ROOT)/Pods/VMNVideoPlayer-iOS-SDK/FrameworkSource/libVMNVideoPlayeriOSSDK/VMNVideoPlayer.framework/Versions/A"/**', 'HEADER_SEARCH_PATHS' => '"$(PODS_ROOT)/Pods/VMNVideoPlayer-iOS-SDK/FrameworkSource/libVMNVideoPlayeriOSSDK/VMNVideoPlayer.framework/Headers"/**' }
  ...
  s.subspec 'FreeWheel' do |free|
	...
	free.frameworks = 'UIKit', 'CoreGraphics', 'QuartzCore', 'MediaPlayer', 'CoreLocation', 'libxml2.dylib'
  end
  ...
  s.library = 'xml2'
  s.frameworks   = 'MessageUI', 'SystemConfiguration', 'CoreText', 'CoreLocation', 'QuartzCore', 'MediaPlayer', 'CoreMedia', 'AVFoundation', 'UIKit', 'Foundation', 'CoreGraphics', 'libxml2.dylib', 'VMNVideoPlayer'
end
